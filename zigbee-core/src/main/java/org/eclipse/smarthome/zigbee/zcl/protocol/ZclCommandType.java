 ...
 */
package org.eclipse.smarthome.zigbee.zcl.protocol;

import java.lang.reflect.Constructor;

import org.eclipse.smarthome.zigbee.zcl.ZclCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.alarms.AlarmCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.alarms.GetAlarmCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.alarms.GetAlarmResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.alarms.ResetAlarmCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.alarms.ResetAlarmLogCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.alarms.ResetAllAlarmsCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.basic.ResetToFactoryDefaultsCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.ColorLoopSetCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.EnhancedMoveToHueAndSaturationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.EnhancedMoveToHueCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.EnhancedStepHueCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.MoveColorCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.MoveHueCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.MoveSaturationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.MoveToColorCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.MoveToColorTemperatureCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.MoveToHueAndSaturationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.MoveToHueCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.MoveToSaturationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.StepColorCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.StepHueCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.colorcontrol.StepSaturationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.commissioning.ResetStartupParametersCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.commissioning.ResetStartupParametersResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.commissioning.RestartDeviceCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.commissioning.RestartDeviceResponseResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.commissioning.RestoreStartupParametersCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.commissioning.RestoreStartupParametersResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.commissioning.SaveStartupParametersCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.commissioning.SaveStartupParametersResponse;
...
import org.eclipse.smarthome.zigbee.zcl.clusters.general.ConfigureReportingCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.ConfigureReportingResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.DefaultResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.DiscoverAttributesCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.DiscoverAttributesExtended;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.DiscoverAttributesExtendedResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.DiscoverAttributesResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.DiscoverCommandsGenerated;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.DiscoverCommandsGeneratedResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.DiscoverCommandsReceived;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.DiscoverCommandsReceivedResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.ReadAttributesCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.ReadAttributesResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.ReadAttributesStructuredCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.ReadReportingConfigurationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.ReadReportingConfigurationResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.ReportAttributesCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.WriteAttributesCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.WriteAttributesNoResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.WriteAttributesResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.WriteAttributesStructuredCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.WriteAttributesStructuredResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.general.WriteAttributesUndividedCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.AddGroupCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.AddGroupIfIdentifyingCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.AddGroupResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.GetGroupMembershipCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.GetGroupMembershipResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.RemoveAllGroupsCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.RemoveGroupCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.RemoveGroupResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.ViewGroupCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.groups.ViewGroupResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.ArmCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.ArmResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.BypassCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.EmergencyCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.FireCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.GetZoneIdMapCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.GetZoneIdMapResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.GetZoneInformationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.GetZoneInformationResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.iasace.PanicCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iaswd.SquawkCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iaswd.StartWarningCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iaszone.ZoneEnrollRequestCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.iaszone.ZoneEnrollResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.iaszone.ZoneStatusChangeNotificationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.identify.IdentifyCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.identify.IdentifyQueryCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.identify.IdentifyQueryResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.levelcontrol.MoveCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.levelcontrol.MoveToLevelCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.levelcontrol.MoveToLevelWithOnOffCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.levelcontrol.MoveWithOnOffCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.levelcontrol.StepCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.levelcontrol.StepWithOnOffCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.levelcontrol.Stop2Command;
import org.eclipse.smarthome.zigbee.zcl.clusters.levelcontrol.StopCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.onoff.OffCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.onoff.OffWithEffectCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.onoff.OnCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.onoff.OnWithRecallGlobalSceneCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.onoff.OnWithTimedOffCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.onoff.ToggleCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.ImageBlockCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.ImageBlockResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.ImageNotifyCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.ImagePageCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.QueryNextImageCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.QueryNextImageResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.QuerySpecificFileCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.QuerySpecificFileResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.UpgradeEndCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.otaupgrade.UpgradeEndResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.AnchorNodeAnnounceCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.CompactLocationDataNotificationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.DeviceConfigurationResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.GetDeviceConfigurationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.GetLocationDataCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.LocationDataNotificationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.LocationDataResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.ReportRssiMeasurementsCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.RequestOwnLocationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.RssiPingCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.RssiRequestCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.RssiResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.SendPingsCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.SetAbsoluteLocationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.rssilocation.SetDeviceConfigurationCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.AddSceneCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.AddSceneResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.GetSceneMembershipCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.GetSceneMembershipResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.RecallSceneCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.RemoveAllScenesCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.RemoveAllScenesResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.RemoveSceneCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.RemoveSceneResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.StoreSceneCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.StoreSceneResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.ViewSceneCommand;
import org.eclipse.smarthome.zigbee.zcl.clusters.scenes.ViewSceneResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.thermostat.ClearWeeklySchedule;
import org.eclipse.smarthome.zigbee.zcl.clusters.thermostat.GetRelayStatusLog;
import org.eclipse.smarthome.zigbee.zcl.clusters.thermostat.GetRelayStatusLogResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.thermostat.GetWeeklySchedule;
import org.eclipse.smarthome.zigbee.zcl.clusters.thermostat.GetWeeklyScheduleResponse;
import org.eclipse.smarthome.zigbee.zcl.clusters.thermostat.SetWeeklySchedule;
import org.eclipse.smarthome.zigbee.zcl.clusters.thermostat.SetpointRaiseLowerCommand;
