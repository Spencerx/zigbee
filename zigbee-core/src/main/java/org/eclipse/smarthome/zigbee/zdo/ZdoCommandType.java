...
import org.eclipse.smarthome.zigbee.zdo.command.ActiveEndpointStoreRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ActiveEndpointStoreResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ActiveEndpointsRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ActiveEndpointsResponse;
import org.eclipse.smarthome.zigbee.zdo.command.BackupBindTableRequest;
import org.eclipse.smarthome.zigbee.zdo.command.BackupBindTableResponse;
import org.eclipse.smarthome.zigbee.zdo.command.BackupSourceBindRequest;
import org.eclipse.smarthome.zigbee.zdo.command.BindRegister;
import org.eclipse.smarthome.zigbee.zdo.command.BindRegisterResponse;
import org.eclipse.smarthome.zigbee.zdo.command.BindRequest;
import org.eclipse.smarthome.zigbee.zdo.command.BindResponse;
import org.eclipse.smarthome.zigbee.zdo.command.CacheRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ComplexDescriptorRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ComplexDescriptorResponse;
import org.eclipse.smarthome.zigbee.zdo.command.DeviceAnnounce;
import org.eclipse.smarthome.zigbee.zdo.command.DiscoveryCacheRequest;
import org.eclipse.smarthome.zigbee.zdo.command.DiscoveryCacheResponse;
import org.eclipse.smarthome.zigbee.zdo.command.DiscoveryStoreRequestRequest;
import org.eclipse.smarthome.zigbee.zdo.command.DiscoveryStoreResponse;
import org.eclipse.smarthome.zigbee.zdo.command.EndDeviceBindRequest;
import org.eclipse.smarthome.zigbee.zdo.command.EndDeviceBindResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ExtendedActiveEndpointRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ExtendedActiveEndpointResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ExtendedSimpleDescriptorRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ExtendedSimpleDescriptorResponse;
import org.eclipse.smarthome.zigbee.zdo.command.FindNodeCacheRequest;
import org.eclipse.smarthome.zigbee.zdo.command.FindNodeCacheResponse;
import org.eclipse.smarthome.zigbee.zdo.command.IeeeAddressRequest;
import org.eclipse.smarthome.zigbee.zdo.command.IeeeAddressResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementBindRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementBindResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementCacheResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementDirectJoinRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementDirectJoinResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementLeaveRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementLeaveResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementLqiRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementLqiResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementNetworkDiscovery;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementNetworkDiscoveryResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementNetworkUpdateNotify;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementPermitJoiningRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementPermitJoiningResponse;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementRoutingRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ManagementRoutingResponse;
...
import org.eclipse.smarthome.zigbee.zdo.command.NetworkAddressRequest;
import org.eclipse.smarthome.zigbee.zdo.command.NetworkAddressResponse;
import org.eclipse.smarthome.zigbee.zdo.command.NetworkUpdateRequest;
import org.eclipse.smarthome.zigbee.zdo.command.NodeDescriptorRequest;
import org.eclipse.smarthome.zigbee.zdo.command.NodeDescriptorResponse;
import org.eclipse.smarthome.zigbee.zdo.command.NodeDescriptorStoreRequest;
import org.eclipse.smarthome.zigbee.zdo.command.NodeDescriptorStoreResponse;
import org.eclipse.smarthome.zigbee.zdo.command.PowerDescriptorRequest;
import org.eclipse.smarthome.zigbee.zdo.command.PowerDescriptorResponse;
import org.eclipse.smarthome.zigbee.zdo.command.PowerDescriptorStoreRequest;
import org.eclipse.smarthome.zigbee.zdo.command.PowerDescriptorStoreResponse;
import org.eclipse.smarthome.zigbee.zdo.command.RecoverBindTableRequest;
import org.eclipse.smarthome.zigbee.zdo.command.RecoverBindTableResponse;
import org.eclipse.smarthome.zigbee.zdo.command.RecoverSourceBindRequest;
import org.eclipse.smarthome.zigbee.zdo.command.RecoverSourceBindResponse;
import org.eclipse.smarthome.zigbee.zdo.command.RemoveBackupBindEntryResponse;
import org.eclipse.smarthome.zigbee.zdo.command.RemoveBackupBindTableRequest;
import org.eclipse.smarthome.zigbee.zdo.command.RemoveNodeCache;
import org.eclipse.smarthome.zigbee.zdo.command.RemoveNodeCacheRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ReplaceDeviceRequest;
import org.eclipse.smarthome.zigbee.zdo.command.ReplaceDeviceResponse;
import org.eclipse.smarthome.zigbee.zdo.command.SimpleDescriptorRequest;
import org.eclipse.smarthome.zigbee.zdo.command.SimpleDescriptorResponse;
import org.eclipse.smarthome.zigbee.zdo.command.SimpleDescriptorStore;
import org.eclipse.smarthome.zigbee.zdo.command.SimpleDescriptorStoreResponse;
import org.eclipse.smarthome.zigbee.zdo.command.StoreBackupBindEntryRequest;
import org.eclipse.smarthome.zigbee.zdo.command.StoreBackupBindEntryResponse;
import org.eclipse.smarthome.zigbee.zdo.command.SystemServerDiscoveryRequest;
import org.eclipse.smarthome.zigbee.zdo.command.UnbindRequest;
import org.eclipse.smarthome.zigbee.zdo.command.UnbindResponse;
import org.eclipse.smarthome.zigbee.zdo.command.UserDescriptorConf;
import org.eclipse.smarthome.zigbee.zdo.command.UserDescriptorRequest;
import org.eclipse.smarthome.zigbee.zdo.command.UserDescriptorResponse;
import org.eclipse.smarthome.zigbee.zdo.command.UserDescriptorSetRequest;
