 ...
 */
package org.eclipse.smarthome.binding.zigbee.xbee.internal;
...
import org.eclipse.smarthome.binding.zigbee.xbee.XBeeBindingConstants;
import org.eclipse.smarthome.binding.zigbee.xbee.handler.XBeeHandler;
 ...
 */
@Component(service = ThingHandlerFactory.class, immediate = true, configurationPid = "org.eclipse.smarthome.binding.zigbee.xbee")
@NonNullByDefault
